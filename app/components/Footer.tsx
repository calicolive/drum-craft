  ...
  return (
    <footer className='bg-neutral-950'>
      <div className='mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8'>
        <div className='mb-8 border border-t border-neutral-900' />
        <nav
          ...
          {navigation.main.map((item) => (
            <div key={item.name} className='pb-6'>
              <a
                href={item.href}
                className='text-sm leading-6 text-neutral-400 hover:text-neutral-200'>
                {item.name}
              </a>
            </div>
          ))}
        ...
        <p className='mt-10 text-center text-xs leading-5 text-neutral-500'>
          &copy; 2020 OSC Audio. All rights reserved.
        </p>
      </div>
    </footer>
  );
